    ...
    if(index + 1 < len_list):
        ...
        if text == "A":
            ...
            if check_anwer('B')[0] == False:
                bot.send_message(cid, "False .. " + check_anwer('B')[1])
                api.set_forgetful_word(check_anwer('B')[2], check_anwer('B')[1], 604800)
            else:
                dem += 1
        elif text == "C":
            if check_anwer('C')[0] == False:
                bot.send_message(cid, "False .. " + check_anwer('C')[1])
                api.set_forgetful_word(check_anwer('C')[2], check_anwer('C')[1], 604800)
            else:
                dem += 1
        elif text == "D":
            if check_anwer('D')[0] == False:
                bot.send_message(cid, "False .. " + check_anwer('D')[1])
                api.set_forgetful_word(check_anwer('D')[2], check_anwer('D')[1], 604800)
            else:
                dem += 1
        else:
    ...
    if(index_memo + 1 < len_list_memo):
        ...
        if text == "A":
            ...
            if check_anwer('B','minhvu')[0] == False:
                bot.send_message(cid, "False .. " + check_anwer('B','minhvu')[1])
                api.set_forgetful_word(check_anwer('B','minhvu')[2], check_anwer('B','minhvu')[1], 604800)
            else:
                dem_memo += 1
        elif text == "C":
            if check_anwer('C','minhvu')[0] == False:
                bot.send_message(cid, "False .. " + check_anwer('C','minhvu')[1])
                api.set_forgetful_word(check_anwer('C','minhvu')[2], check_anwer('C','minhvu')[1], 604800)
            else:
                dem_memo += 1
        elif text == "D":
            if check_anwer('D','minhvu')[0] == False:
                bot.send_message(cid, "False .. " + check_anwer('D','minhvu')[1])
                api.set_forgetful_word(check_anwer('D','minhvu')[2], check_anwer('D','minhvu')[1], 604800)
            else:
                dem_memo += 1
        else:
            bot.send_message(cid, "Please try again")
